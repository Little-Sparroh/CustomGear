...
/// State lives on <see cref="DmlrReworkBehaviour"/>; this type is stateless logic.
/// </summary>
internal static class SeveranceSystem
{
    ...
    public static EnemyPart FindTransferDestination(EnemyPart from, DmlrReworkBehaviour behaviour)
    {
        if (from == null)
            return null;
    ...
    private static void SetDrillFocus(DmlrReworkBehaviour b, int brainId, EnemyPart shell)
    {
    ...
    private static void ClearDrillFocus(DmlrReworkBehaviour b, int brainId)
    {
        if (b == null)
            return;
    ...
    public static float GetTransferPercent(DmlrReworkBehaviour behaviour, bool laserMode)
    {
        if (behaviour == null)
            return 0f;
    ...
    public static void ApplyMark(DmlrReworkBehaviour b, EnemyPart part, float duration)
    {
    ...
    public static bool IsMarked(DmlrReworkBehaviour b, EnemyPart part)
    {
    ...
    public static void ExposeBrain(DmlrReworkBehaviour b, EnemyBrain brain, float duration)
    {
    ...
    public static bool IsBrainExposed(DmlrReworkBehaviour b, EnemyBrain brain)
    {
    ...
    public static bool IsTargetExposed(DmlrReworkBehaviour b, ITarget target)
    {
    ...
    public static void ApplyOpenArtery(DmlrReworkBehaviour b, EnemyBrain brain, float duration)
    {
        if (b == null || brain == null || duration <= 0f)
            return;
    ...
    public static bool TryConsumeOpenArtery(DmlrReworkBehaviour b, EnemyBrain brain, out float bonusTransfer)
    {
        bonusTransfer = 0f;
    ...
    public static void RecordPotentialOverkill(DmlrReworkBehaviour b, EnemyPart part, float rawDamage)
    {
    ...
    public static bool TryTakeOverkill(DmlrReworkBehaviour b, EnemyPart killed, out float overkill)
    {
        overkill = 0f;
    ...
    public static void ClearOverkill(DmlrReworkBehaviour b)
    {
        if (b == null)
            return;
    ...
    public static void PruneExpired(DmlrReworkBehaviour b)
    {
        if (b == null)
            return;
