...
/// </summary>
public sealed class MarksmanLaserRifleBehaviour : MonoBehaviour
{
    [Serializable]
    public struct Data
    {
    ...
    public void CopySnapshotFrom(MarksmanLaserRifleBehaviour template)
    {
        if (template == null)
            return;
    ...
    public static bool TryGet(IGear gear, out MarksmanLaserRifleBehaviour behaviour)
    {
        behaviour = null;
        if (gear?.gameObject == null)
            return false;

        behaviour = gear.gameObject.GetComponent<MarksmanLaserRifleBehaviour>();
        if (behaviour != null)
            return true;

        bool isOurs = SparrohPlugin.IsOurGear(gear);
        MarksmanLaserRifleBehaviour prefabBehaviour = null;
        if (gear.Prefab is Component prefabComp)
            prefabBehaviour = prefabComp.GetComponent<MarksmanLaserRifleBehaviour>();
        ...
        behaviour = gear.gameObject.AddComponent<MarksmanLaserRifleBehaviour>();
