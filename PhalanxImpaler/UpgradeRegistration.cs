...
/// <summary>
/// Helpers for creating custom upgrades (Phase 4+). Empty-grid build does not register cards yet.
/// Kept so later paths can call PlayerData.CreateUpgrade against phalanx_impaler.
/// </summary>
public static class UpgradeRegistration
{
    public static bool TryCreateMeleeUpgrade(
        string modGuid,
        IUpgradable gear,
        string gearApiName,
        int upgradeId,
